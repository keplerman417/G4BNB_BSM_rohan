...
public:
  ...
  G4double GetPionZeroBeMomentumMin()  { return pizeroBeMin; }
  ...
  G4double GetPionZeroBeMomentumMax()  { return pizeroBeMax; }
  ...
  G4double GetPionZeroAlMomentumMin()  { return pizeroAlMin; }
  ...
  G4double GetPionZeroAlMomentumMax()  { return pizeroAlMax; }
  ...
  void SetPionZeroBeMomentumRange(G4double min, G4double max)   { pizeroBeMin = min; pizeroBeMax = max; }
  ...
  void SetPionZeroAlMomentumRange(G4double min, G4double max)    { pizeroAlMin = min; pizeroAlMax = max; }
  ...
  // pi zero-Be
  void SetPiZeroBeTotParameter(G4double* values, G4int nvars){ for(int i = 0; i < nvars; i++)pizeroBeTotParameters.push_back(values[i]); }
  void SetPiZeroBeQelParameter(G4double* values, G4int nvars){ for(int i = 0; i < nvars; i++)pizeroBeQelParameters.push_back(values[i]); }
  void SetPiZeroBeIneParameter(G4double* values, G4int nvars){ for(int i = 0; i < nvars; i++)pizeroBeIneParameters.push_back(values[i]); }

  // pi zero-Al
  void SetPiZeroAlTotParameter(G4double* values, G4int nvars){ for(int i = 0; i < nvars; i++)pizeroAlTotParameters.push_back(values[i]); }
  void SetPiZeroAlQelParameter(G4double* values, G4int nvars){ for(int i = 0; i < nvars; i++)pizeroAlQelParameters.push_back(values[i]); }
  void SetPiZeroAlIneParameter(G4double* values, G4int nvars){ for(int i = 0; i < nvars; i++)pizeroAlIneParameters.push_back(values[i]); }
...
private:
  ...
  G4double pizeroBeMin, pizeroBeMax, pizeroAlMin, pizeroAlMax;
  ...
  // pizero
  std::vector<G4double>  pizeroBeTotParameters;
  std::vector<G4double>  pizeroBeQelParameters;
  std::vector<G4double>  pizeroBeIneParameters;

  std::vector<G4double>  pizeroAlTotParameters;
  std::vector<G4double>  pizeroAlQelParameters;
  std::vector<G4double>  pizeroAlIneParameters;
