...
void BooNEHadronElasticDataSet::DumpPhysicsTable2()
{
  G4cout << "Dumping out Elastic Cross sections on Be " << G4endl;
  ...
  G4cout << "Dumping out Elastic Cross sections on Al " << G4endl;
